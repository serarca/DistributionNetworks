...
int main(){
   ...
   string filename = "spatial/spatial_day_13";
   ...
   //string iter = "1";
   //DualSolution partial_sol = read_dual_solution(vrp.folder+"dual_solutions/"+vrp.name+"_"+iter+".json");
   ...
   // DualSolution lb = optimize_lower_bound_M2(iterations_grad_m2, z_ub, Delta, Delta_zero, gamma, gamma_zero, epsilon, vrp, partial_sol);
